...
ActiveRecord::Schema.define(version: 20160628114853) do
  ...
  add_index "pictures", ["group_post_id"], name: "index_pictures_on_group_post_id", using: :btree
  ...
  add_foreign_key "pictures", "group_posts"
